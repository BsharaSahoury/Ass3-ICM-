				...
				if (arg3[0] instanceof String) {
					...
					if (keymessage.equals("manualEvaluator")) {
						...
						if (flag) {
							...
							Notification n1 = new Notification("You've been recruited to evaluate request#" + id,
									new java.sql.Date(millis), "recruitNotificationForEvaluator");
						...
						if (flag) {
							...
							long millis = System.currentTimeMillis();
							Notification n1 = new Notification("You've been recruited to test request#" + id,
									new java.sql.Date(millis), "recruitNotificationForTester");
							n1 = mysqlConnection.insertNotificationToDB(con, n1);
						...
						mysqlConnection.assignorChangeEmployee(con, employee.getUsername(), repetion, id, phase, start,
								due);
						...
						for (int i = 0; i < selected.size(); i++) {
							...
							Notification n2 = new Notification("You've been recruited to performe request#" + id,
									new java.sql.Date(millis), "recruitNotificationForPerformEngineer");
						...
						if (employee2.getJob().equals("engineer")) {
							Notification n3 = new Notification(
									...
									new java.sql.Date(millis), "ReplaceNotificationforlastperformanceadmin");
