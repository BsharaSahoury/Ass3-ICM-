...
public class ServerInitiatorapprovetherejectObserver implements Observer {
	public ServerInitiatorapprovetherejectObserver(Observable server) {
			...
			if(arg2[1] instanceof Object[]) {
				...
				if(arg3[0] instanceof String) {
					...
					if(keymessage.equals("initiator approved the decision of the request")) {
						...
						String not="the initiator approved the reject for request id#"+id+"and the request closed";
						Notification decisionnot=new Notification(not,new java.sql.Date(millis),"initiator approved the reject");
